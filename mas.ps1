...
& {
    ...
    $URLs = @(
        'https://mas.fsy.qzz.io/MAS_AIO.cmd', 
        'https://mas.fsyfsyfsy.dpdns.org/MAS_AIO.cmd', 
        'https://raw.githubusercontent.com/FuSiYu666/Microsoft-Activation-Scripts/refs/heads/main/MAS_AIO.cmd',
    ...
    $releaseHash = 'B5BE06C21F70F94036F4442F487C42315E20046A8748E707364E46D31B0A1DE5'
